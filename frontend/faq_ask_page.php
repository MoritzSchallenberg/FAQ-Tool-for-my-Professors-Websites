<?php
/*
 * Beispiel-Frontend fuer das Frageformular der Studierenden.
 */
...
<div id="seite">
    ...
    <div id="headnavi">
        <span class="passiv">
            <a href="faq_public_page.php?ref_id=<?php echo htmlspecialchars($_GET['ref_id'] ?? ($_POST['ref_id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">FAQ</a>
        </span>
        <span class="passiv">
            <a href="faq_ask_page.php?ref_id=<?php echo htmlspecialchars($_GET['ref_id'] ?? ($_POST['ref_id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">Frage stellen</a>
        </span>
    </div>
    <div id="logo">
    ...
    <div id="inhalt" class="csc-default">
        ...
        <?php include __DIR__ . '/../php_integration/faq_ask_snippet.php'; ?>
        <p><a href="faq_public_page.php?ref_id=<?php echo htmlspecialchars($_GET['ref_id'] ?? ($_POST['ref_id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">Zur FAQ-Uebersicht</a></p>
    </div>
